...
(
    ...
    MaxLogHistory int,
    CacheSize int,
    ClientAuthCertificate varchar(50),
    SMSCertificate varchar(50),
...
begin
    IF EXISTS (SELECT * FROM dbo.Configuration WITH (updlock,serializable) WHERE Name='ClientHealth' AND Version < '0.7.7')
    UPDATE dbo.Configuration SET Version='0.7.7' WHERE Name = 'ClientHealth'
end
else
begin
    INSERT INTO dbo.Configuration (Name, Version)
    VALUES ('ClientHealth', '0.7.7')
end
commit tran
